...
<input type="text" name="user_id" id="user_id" value="${userid}" ><!-- class="form-control" --> </td><br>
</tr>
<tr>
...
<hr>
아이디 비밀번호를 잃어버리셨습니까?</label><input type="button" value="아이디/비밀번호 찾기" onclick=""><br>
아직 회원이 아니시라면 가입하세요. &nbsp;&nbsp;<input type="button" value="회원가입" onclick="location.href='memberInsert'" ><br>
</td>
